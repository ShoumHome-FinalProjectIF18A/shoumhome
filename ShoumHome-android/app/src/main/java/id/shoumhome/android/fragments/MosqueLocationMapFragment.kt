 ...
 * Use the [MosqueLocationMapFragment.newInstance] factory method to
...
class MosqueLocationMapFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment MosqueLocationMapFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                MosqueLocationMapFragment().apply {
